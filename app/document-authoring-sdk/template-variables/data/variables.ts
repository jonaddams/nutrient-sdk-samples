...
export const VARIABLE_CATEGORIES: VariableCategory[] = [
  {
    ...
    variables: [
      ...
      { label: "Company Address", token: "companyAddress", sampleValue: "123 Business Ave, Suite 100" },
      { label: "Company City", token: "companyCity", sampleValue: "San Francisco, CA 94105" },
      { label: "Company Email", token: "companyEmail", sampleValue: "billing@acmecorp.com" },
      { label: "Company Phone", token: "companyPhone", sampleValue: "(555) 123-4567" },
    ],
  },
  {
    name: "Client",
    variables: [
      ...
      { label: "Client Company", token: "clientCompany", sampleValue: "Smith & Associates" },
      { label: "Client Address", token: "clientAddress", sampleValue: "456 Oak Street" },
      { label: "Client City", token: "clientCity", sampleValue: "Portland, OR 97201" },
      { label: "Client Email", token: "clientEmail", sampleValue: "jane@smithassociates.com" },
    ],
  },
  {
    name: "Invoice",
    variables: [
      { label: "Invoice Number", token: "invoiceNumber", sampleValue: "INV-2026-0042" },
      { label: "Invoice Date", token: "invoiceDate", sampleValue: "April 14, 2026" },
