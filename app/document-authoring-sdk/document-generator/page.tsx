        ...
        constructor(
          ...
          const safeCallback: IntersectionObserverCallback = (
            ...
            try {
              ...
              console.warn("🛡️ Suppressed IntersectionObserver error:", error instanceof Error ? error.message : String(error));
              return;
            }
          };
