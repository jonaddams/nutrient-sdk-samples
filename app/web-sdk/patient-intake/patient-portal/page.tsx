...
export default function PatientPortal() {
  ...
  const [missingSignatureField, setMissingSignatureField] = useState<
    string | null
  >(null);
    ...
    try {
      ...
      for (const field of signatureFields) {
        ...
        if (overlapping.size === 0) {
          ...
          setMissingSignatureField(field.name.replace(/_/g, " "));
          return false;
        }
      }
  ...
  if (currentDocument) {
    return (
      <div className="min-h-screen" style={{ background: "var(--background)" }}>
        ...
        <ConfirmDialog
          open={!!missingSignatureField}
          title="Signature required"
          message={`Please sign all required signature fields before continuing. Missing signature for: ${missingSignatureField ?? ""}.`}
          confirmLabel="OK"
          dismissOnly
          onConfirm={() => setMissingSignatureField(null)}
          onCancel={() => setMissingSignatureField(null)}
        />
      </div>
    );
  }
            ...
            >
              ...
              >
                ...
                <p>
                  ...
                  {patientData?.visitInfo.reasonForVisit}
                </p>
              </div>
            </div>
          </div>
